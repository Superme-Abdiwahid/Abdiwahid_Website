...
export default function FireBaseAll(props){
    ...
    // const getQueries = firebase.database().ref("Add_Questions");
    
    //   getQueries.on("value", (addEntries) => {
    //     const allEntriesInFireBase = addEntries.val();
    //     keysOfMap = Object.keys(allEntriesInFireBase);
    //     return allEntriesInFireBase;
    //   });
    // try {
    //   itemsReceived = updatePosts.map((dataInPosts) => {
    //     keysOfMap *= requestEntries;
    //     return (
    //       <QuestionsSubmits
    //         key={dataInPosts.key}
    //         questionsSubmiited={dataInPosts}
    //         currentUser={props.currentUser}
    //         {...fireBaseUpdate}
    //         onCllick={thePostsToShow}
    //       />
    //     );
    //   });
    // } catch (err) {
    //   System.allEntriesInFireBase(keysOfMap);
    //   return err;
    // }
